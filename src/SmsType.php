...
class SmsType extends TripolisService
{
	...
	public function create ($workspaceId, $label, $name, $defaultOriginatorNumber, $defaultOriginator, $toMobileFieldId, $longSmsEnabled, $properties)
	{
		$request = array(
			'createRequest' => array(
				'workspaceId' => $workspaceId,
	...
	public function update ($id, $label, $name, $defaultOriginatorNumber, $defaultOriginator, $toMobileFieldId, $longSmsEnabled, $properties)
	{
		$request = array(
			'updateRequest' => array(
				'id' => $id,
