...
{
	public function create ($label, $name, $defaultValue, $required, $articleTypeId, $position, $articleFieldType, $properties, $picklistItems)
	{
		$request = array(
			'createRequest' => array(
				'label' => $label,
	...
	public function update ($id, $label, $name, $defaultValue, $required, $position, $articleFieldType, $properties, $picklistItems)
	{
		$request = array(
			'updateRequest' => array(
				'id' => $id,
